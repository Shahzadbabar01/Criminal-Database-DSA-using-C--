...
int Robbery :: deleteData(string deleteId)
{
    if(!isEmpty())
    {
     if(head -> id == deleteId)
...
void Robbery :: addData(string id1, string date1, string name1, string phone_no1, string address1, string crime1, string charges1, string criminalDetails1)
{
            RobberyNode *temp = new RobberyNode;
            temp -> id = id1;
            temp -> date = date1;
            temp -> name = name1;
...
void Robbery :: saveData()
{
      ofstream myFile("RobberyCriminals.txt" , ios::app);
           RobberyNode *temp;
           temp = head;
           while(temp != NULL)
           {
...
int Robbery :: countFileLines()
{
    string asd;
    int countLines = 0;
    ifstream myFile("RobberyCriminals.txt");
    if(myFile.is_open())
    {
...
void Robbery :: clearFile()
{
    ofstream File("RobberyCriminals.txt", ios::trunc);
    File.close();
}

bool Robbery :: searchData(string key)
{
     if(!isEmpty())
    {
        RobberyNode *temp;
...
void Robbery :: readFile()
{
    ifstream File("RobberyCriminals.txt");
    if(File.is_open())
    {
         int i = 0;
    int j = 1;
...
void Robbery :: updateData(string upDateId)
{
     if(!isEmpty())
    {
    displayData();
